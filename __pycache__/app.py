...
item1 = html.Div(
    [
        html.P("Welcome to the Stock Forecasting Application By Sarthak and Ananya", className="start"),

        html.Div([
            # stock code input
            dcc.Input(id='stock-code', type='text', placeholder='Enter the stock code'),
            html.Button('Examine', id='submit-button')
        ...
        html.Div([
            # Stock price button
            html.Button('Get Price', id='stock-price-button'),

            # Indicators button
            html.Button('Get Indicator', id='indicators-button'),

            # Number of days of forecast input
            dcc.Input(id='forecast-days', type='number', placeholder='Enter number of days'),

            # Forecast button
            html.Button('Get Your Forecast Chart', id='forecast-button')
        ], className="selectors")
    ],
    className="nav"
)
